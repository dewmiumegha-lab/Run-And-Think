...
public class MathQuestionManager_Level2 : MonoBehaviour
{
    ...
    public void ShowSubtractionQuestion()
    {
        int a = Random.Range(10, 100);
        int b = Random.Range(1, a); // ensure a - b is not negative
        correctAnswer = a - b;
    ...
    void GameOver()
    {
        ...
        // Save current level index before loading Game Over
